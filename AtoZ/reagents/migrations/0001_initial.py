    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('title', models.CharField(blank=True, max_length=300, null=True)),
                ('upload', models.FileField(upload_to='docx/')),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('reagent_name', models.CharField(blank=True, max_length=300, null=True)),
                ('catalogue_no', models.CharField(blank=True, max_length=300, null=True)),
                ('reagent_url', models.CharField(blank=True, max_length=300, null=True)),
                ('reagent_storage', models.CharField(blank=True, max_length=10, null=True)),
                ('reagent_supplier', models.CharField(blank=True, max_length=64, null=True)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
